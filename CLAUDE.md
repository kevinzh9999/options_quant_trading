...
|------|------|------|------|-----------|-------------|-------|-----------|-------|
| IM | 动量 | **实盘** | 60 | 1.1/0.9 | 1.5x | 动态4/12 | +2148 | +9.8 |
| IC | 动量 | **实盘** | 60 | 1.1/0.9 | 2.0x | 动态4/12 | +2125 | +9.7 |
| IF | 均值回归 | 观察 | 60 | 1.0/1.0 | 1.0x | 动态4/12 | 未测 | — |
| IH | — | 放弃 | 60 | 1.1/0.9 | 1.0x | 动态4/12 | 未测 | — |

IM+IC合计 **+4273pt/219天**（2025-05-16~2026-04-09）。含Q分分位数法+15m重采样修复+vol_profile���链路贯通。
...
### 信号阈值（2026-04-08更新）
- **默认阈值 60**（Q分改为分位数法后重新验证，IM和IC均为60最优）
- 阈值来源：`SYMBOL_PROFILES.signal_threshold`（IM=60, IC=60, IF=60, IH=60）
