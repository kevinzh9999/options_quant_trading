...
|------|------|------|------|-----------|-------------|-------|-----------|-------|
| IM | 动量 | **实盘** | 60 | 1.1/0.9 | 1.5x | 动态4/12 | +2323 | +10.7 |
| IC | 动量 | **实盘** | 60 | 1.1/0.9 | 2.0x | 动态4/12 | +2310 | +10.6 |
| IF | 均值回归 | 观察 | 60 | 1.0/1.0 | 1.0x | 动态4/12 | 未测 | — |
| IH | — | 放弃 | 60 | 1.1/0.9 | 1.0x | 动态4/12 | 未测 | — |

IM+IC合计 **+4633pt/218天**（2025-05-16~2026-04-08）。Q分改为历史同时段分位数法后的更真实baseline。
